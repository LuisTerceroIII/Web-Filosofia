                    ...
                    <nav className="navbar navbar-expand-lg navbar-light bg-light">
                            <ul className="navbar-nav">
                                <li className="nav-item">
                                    <Link className="nav-link" to={"/Web-Filosofia"}>{this.props.menu[0]}</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/Web-Filosofia/history">{this.props.menu[1]}</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/Web-Filosofia/schools">{this.props.menu[2]}</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link" to="/Web-Filosofia/philosopher">{this.props.menu[3]}</Link>
                                </li>
                                <li className="nav-item">
